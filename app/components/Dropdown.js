  ...
  return (
    <div className="h-screen flex items-center">
      ...
      <Listbox value={selected} onChange={setSelected}>
        <ListboxButton
          className={clsx(
            "relative block max-w-2/6 min-w-1/4 rounded-lg bg-purple-700 py-1.5 pr-8 pl-3 text-left text-sm/6 text-white",
        ...
        <ListboxOptions
          ...
          transition
          className={clsx(
            "w-(--button-width) rounded-xl border border-white/5 bg-purple-100  p-1 [--anchor-gap:--spacing(1)] focus:outline-none",
